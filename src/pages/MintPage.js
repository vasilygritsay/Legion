...
function MintPage() {
  ...
  async function handleError(err) {
    ...
    if (err.message?.includes("insufficient funds") || err.data?.message?.includes("insufficient funds")) {
  ...
  function valueUpCredit() {
    if (creditquantity < 150) {
      setCreditQuantity(creditquantity + 1);
    }
  }
  function valueDownCredit() {
    if (creditquantity > 1) {
      setCreditQuantity(creditquantity - 1);
    }
  }
      ...
      <section className="main">
        ...
        <div className='main-content'>
          ...
          <div className="containerr onboard">
            ...
            <img src="logo.png" className="logobox" alt="" />
            ...
            {<>
              <div>
                ...
                {wallet && connectedChain.id == "0x89" && loading && <h2>Loading...</h2>}
                {wallet && connectedChain.id !== "0x89" && <div className="buttonswitch" onClick={switchNetworkPOLYGON}><h2>Switch to Polygon Network</h2><img src="/assets/polygon.svg" className='buttonlogo' alt="" /></div>}
                  ...
                  <div className="minting">
                    {data.step != 0 && data.step != null ? (<>
                      ...
                      <div className='progress'>
                        <h3 className="minted">Total minted &nbsp;({data.totalSupply} / 10000) - {Math.round((data.totalSupply * 100 / 10000)) + '%'}</h3>
                        <Box sx={{ width: '100%', height: '60px' }}>
                          <LinearProgressWithLabel value={(data.totalSupply * 100 / 10000)} />
                        </Box>
                      </div>
                    </>
                    ) : (
            ...
            {/*} <div className="wrapper">
              <div className='wrapper-section'>
                <input type="text" required placeholder="Enter your wallet address" onChange={(e) => setAddresswl(e.target.value)} value={addresswl} />
...
*/}
            <CrossmintPayButton
              ...
              mintConfig={{ "type": "erc-721", "totalPrice": String(80 * creditquantity), "_quantity": creditquantity }}
            />
            <div className='quantitymint credit'>
              <h2>Credit Card <br /> Quantity</h2>
              <input
                type="number"
                id="creditquantity"
                min="1"
              ...
              />
              <div className="quantitybuttons">
                <div className="arrowup" onClick={valueUpCredit}></div>
                <div className="arrowdown" onClick={valueDownCredit}></div>
              </div>
            </div>
